...
线性回归模型是一个朴素而强大的工具，可以帮我们发现潜藏于数据下的规律，具体来讲，是因素如何影响目标变量的规律。

# 一元线性回归模型
我们从一个简单的问题切入：每周运动时间和预期寿命的关系。

假设我们跟踪统计了200个人的每周运动时长和最终寿命，把数据画成散点图：横轴为每周运动小时数，纵轴为寿命。

![每周运动时间和预期寿命的关系](/images/docs/02-linear-regression/exercise_hours_and_lifespan.png)
...
> [!WARNING]
> 线性回归要做的，就是在这些散点中，画一条最贴合的直线，这条直线代表了运动时长与寿命的关系。
